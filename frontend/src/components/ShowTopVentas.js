...
export default class ShowTopVentas extends Component {
    render() {
        return (
            <div className="row mx-3">
                <div className="col-md-4">
                ID de la tienda Y Ventas en $
                </div>
    ...
    async getTopVentas() {
        const res = await axios.get(backend.host + ':' + backend.port + '/topVentas');
